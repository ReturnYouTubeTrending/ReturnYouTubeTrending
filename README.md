...
The [Trending API](https://developers.google.com/youtube/v3/docs/videos/list) is alive which can be used for fixing the extension, but for now I have no plans to implement it in the extension. If you're interested in contributing, leave an [issue](https://github.com/Dr-Sauce/ReturnYouTubeTrending/issues).
